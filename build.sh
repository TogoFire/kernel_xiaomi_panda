...
CLANG_VERSION="clang-playground"
    ...
    git clone --depth=1 https://gitlab.com/dakkshesh07/neutron-clang ${CLANG_VERSION}
    cd ${CLANG_VERSION} && chmod +x antman && bash -v ./antman -S && bash -v ./antman -U && bash -v ./antman -I
    cd ..
